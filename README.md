...
1. what happens at this point is server specific<sup>[1]</sup>, if you're running [armadietto](https://github.com/remotestorage/armadietto) (as per step 2) continue on
...
<sup>[1]</sup> If you're not running [armadietto](https://github.com/remotestorage/armadietto), you may need to first on-board a *tester* user in that server's specific way.

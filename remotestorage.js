            ...
            return this.rs.local.getNodes([path]).then((nodes) => {
                ...
                // Push PUT:
                    ...
                    return this.rs.local.setNodes(this.flush(nodes)).then(() => {
                        ...
                        return taskFor('put', path, this.rs.remote.put(path, node.push.body, // TODO string | ArrayBuffer?
                        node.push.contentType, options));
                    });
                }
                // Push DELETE:
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.collectTasks(false).then(() => {
                ...
                if (!this.hasTasks() || this.stopped) {
                    (0, log_1.default)('[Sync] Sync is done! Reschedule?', Object.keys(this._tasks).length, this.stopped);
                    if (!this.done) {
                        this.done = true;
